...
df2=pd.read_csv('o1_lspuf.csv',header=None)
#df3=pd.read_csv('o2_lspuf.csv',header=None)
#df4=pd.read_csv('o3_lspuf.csv',header=None)

# fix random seed for reproducibility
numpy.random.seed(42)

# split into input (X) and output (Y) variables
X = df1.iloc[:299999,:129]
Y = df2.iloc[:299999,:]
...
model.add(Dense(30,input_dim=129, activation='relu'))
