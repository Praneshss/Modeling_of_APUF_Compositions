...
df1=pd.read_csv('../dataset/APUF_XOR_Challenge_Parity_128_1Million.csv',header=None)
df2=pd.read_csv('4_4testSetResponses_128_1Million.csv',header=None)

# fix random seed for reproducibility
numpy.random.seed(42)

# split into input (X) and output (Y) variables
X = df1.iloc[:809999,:129]
Y = df2.iloc[:809999,:]
...
model.add(Dense(60,input_dim=129, activation='relu'))
